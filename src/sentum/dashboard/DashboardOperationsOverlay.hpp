...
function badgeClass(v){const s=String(v||'').toUpperCase();return s.includes('CRITICAL')||s.includes('BLOCKED')||s.includes('FORBIDDEN')||s.includes('UNAVAILABLE')?'negative':s.includes('WARNING')||s.includes('ATTENTION')||s.includes('STALE')||s.includes('APPROVAL')||s.includes('FLAPPING')?'warn':'positive'}
...
function install(){
 ...
 const section=document.createElement('section');section.id='operationsView';section.className='view';section.innerHTML=`<div class="ops-grid"><div class="ops-card"><div class="label">Runtime</div><div id="opsRuntime" class="value">—</div></div><div class="ops-card"><div class="label">Governance</div><div id="opsGovernance" class="value">—</div></div><div class="ops-card"><div class="label">Evidence</div><div id="opsEvidence" class="value">—</div></div><div class="ops-card"><div class="label">Transport</div><div id="opsTransport" class="value">CONNECTING</div></div><div class="ops-card"><div class="label">Alerts active</div><div id="opsAlertActive" class="value">0</div></div><div class="ops-card"><div class="label">Alerts acknowledged</div><div id="opsAlertAck" class="value">0</div></div><div class="ops-card"><div class="label">Alerts suppressed</div><div id="opsAlertSuppressed" class="value">0</div></div><div class="ops-card"><div class="label">Flapping alerts</div><div id="opsAlertFlapping" class="value">0</div></div><div class="ops-card"><div class="label">Critical / Warning</div><div id="opsAlertSeverity" class="value">0 / 0</div></div><div class="ops-card"><div class="label">Pending approvals</div><div id="opsApprovals" class="value">0</div></div><div class="ops-card"><div class="label">Maintenance</div><div id="opsMaintenance" class="value">—</div></div><div class="ops-card"><div class="label">Incident</div><div id="opsIncident" class="value">—</div></div><div class="ops-card"><div class="label">Recovery</div><div id="opsRecovery" class="value">—</div></div><div class="ops-card"><div class="label">Authority</div><div id="opsAuthority" class="value">READ ONLY</div></div><div class="ops-card ops-wide"><div class="section">Alert Center</div><div id="opsAlertNoise" class="ops-muted"></div><div id="opsAlertList" class="ops-list"></div></div><div class="ops-card ops-wide"><div class="section">Operational Workflows</div><div id="opsWorkflows" class="ops-list"></div></div><div class="ops-card ops-wide"><div class="section">Approval Queue</div><div id="opsApprovalList" class="ops-list"></div></div><div class="ops-card ops-wide"><div class="section">Audit Timeline</div><div id="opsAuditList" class="ops-list"></div></div></div>`;
...
function alertRow(a){const sev=String(a.severity||'').toUpperCase(),cls=sev==='CRITICAL'?' critical':sev==='WARNING'?' warn':'';return `<div class="ops-row${cls}"><b>${safe(a.severity)} · ${safe(a.state)} · ${safe(a.attention||'VISIBLE')}</b> · ${safe(a.id)} · ${safe(a.title)} · gen ${safe(a.generation)}${a.flapping?' · FLAPPING':''}${a.acknowledged_by?` · ack ${safe(a.acknowledged_by)}`:''}</div>`}
